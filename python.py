...
x='  Welcome Sir , I am Gideon , how can I help You'
x=x.center(210)
print(colored( x , 'grey', 'on_yellow')) 
pyttsx3.speak("Welcome Sir , I am Gideon , how can I help You")
...
while True:
      ...
      if (("run" in x) or ("execute" in x) or ("open" in x)) and (("notepad" in x) or ("text" in x)):
        ...
        os.system('VirtualBox') 
         ...
         os.system('explorer') 
      elif (("open" in x) or ("run" in x)) and ( ("Cisco" in x) or ("Webex" in x) or ("meeting")):
         pyttsx3.speak('Launching Cisco Webex')
         c="Launching  Cisco Webex"
         c=c.center(210)
